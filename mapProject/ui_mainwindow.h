...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(setPosition, 3, 0, 1, 1);
        ...
        gridLayout->addLayout(mapLayout, 4, 0, 1, 1);

        positionName = new QLineEdit(centralwidget);
        positionName->setObjectName(QString::fromUtf8("positionName"));

        gridLayout->addWidget(positionName, 2, 0, 1, 1);
